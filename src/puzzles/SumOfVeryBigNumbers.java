...
public class SumOfVeryBigNumbers {
	public static void main(String args[]) {
		SumOfVeryBigNumbers sum = new SumOfVeryBigNumbers();
		/*String result = sum.sum("578932213765435452564354767878698845342345467687658799095645645435",
				"24324546576547654857412121765416541546156526154654361543621846513");
	...
	public String sum(String firstNumber, String secondNumber) {
		...
		for (int i = firstNumber.length() - 1; i >= 0; i--) {
			String sum = carryOver
					+ (Integer.parseInt(firstNumber.charAt(i) + "") + Integer.parseInt(secondNumber.charAt(i) + ""))
					+ "";
			if (sum.length() == 2) {
